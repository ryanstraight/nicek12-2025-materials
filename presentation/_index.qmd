...
title-slide-attributes:
  data-notes: |
      ...
      Quick intros—I'm **Dr. Ryan Straight**, and I'm joined by **Rob Honomichl** and **Paul Wagner**. We're all from the **University of Arizona's Cyber Operations program** in the College of Information Science. Between us, we teach everything from cyber law and ethics to technical security operations.
      ...
      We have **35 minutes together**. Quick context, then we dive into **three activities** you can try right here, right now. Let's go!
...
- Low-resource options (no 1:1 devices? no problem)
- 12 lesson plans (3 activities × 4 grade bands)
- Ready-to-print materials & rubrics
:::
...
::: {.fragment}
*Today's SOC analysts use AI to triage thousands of alerts—but humans make the call. That's the job your students are preparing for.*
:::
...
But in actual cybersecurity work? AI is a partner. Security Operations Centers are drowning in alerts—thousands per day. AI triages them, prioritizes them, spots patterns. But humans decide what's real, what to escalate, what to do. That's not future-state. That's TODAY.

The professionals who thrive are the ones who know how to work WITH AI—when to trust it, when to verify it, when to override it.
...
**12 minutes** | Grades 6-8 (adaptable K-12) | *NICE: Cyber Defense Analyst*
...
**🤖 AI Security Analysis** *(This is what students see)*
...
3. **Write your theory:** Why this person? Why now?
...
[Click countdown] "Go! Two minutes. Read everything. What do YOU notice?"
...
After timer: "Pens down. Before I show you anything—let me ask..."
:::
...
Did you feel that moment? That's what we're engineering.
:::
...
**12 minutes** | Grades 6-8 (adaptable K-12) | *NICE: Cyber Policy Planner*
...
**The progression:** In Activity 1, you partnered with AI to INVESTIGATE. Now you're designing rules FOR AI—moving from "working together" to "governing together." That's a higher-order skill.
...
**3 minutes** | Grades 6-8 (adaptable K-12) | *NICE: Incident Responder*

::: {.fragment}
**The design:** AI recommends actions, humans decide

**The discovery moment:** Students realize they're making real career decisions—Incident Responder is a job.
:::
...
::: {.fragment}
**You just made decisions an Incident Responder makes daily.**

That's Work Role PR-CIR in the NICE Framework.
:::
...
You just did what Incident Responders do. That's a real career—Work Role PR-CIR in the NICE Framework. Your students can see themselves in that role.
