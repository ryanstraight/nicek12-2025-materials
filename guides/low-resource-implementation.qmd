...
flowchart TD
    ...
    NONE["No devices"]
    TEACHER["Teacher device only"]
    FEW["2-3 student devices"]
    HOME["Home access only"]

    NONE_A["Pre-Generated Cards<br/>+ Teacher Role-Play"]
    TEACHER_A["Teacher as AI Voice<br/>+ Think-Aloud Demo"]
    FEW_A["Rotation Station<br/>+ Response Cards"]
    HOME_A["Homework Prep<br/>+ Class Synthesis"]

    START --> NONE & TEACHER & FEW & HOME
    NONE --> NONE_A
    TEACHER --> TEACHER_A
    FEW --> FEW_A
    HOME --> HOME_A
    ...
    style TEACHER fill:#0C234B,stroke:#0C234B,color:#fff
    ...
    style TEACHER_A fill:#f5f5f5,stroke:#0C234B,color:#0C234B
